...
namespace WebShop.Controllers
{
    ...
    public class AccountController : BaseController
    {
            ...
            try
            {
                ...
                if (user != null)
                {
                    ...
                    if (tempCartId != null)
                    {
                        ...
                        var updateResult = blInvoice.UpdateUserId(tempCartId.Value, user.Id);
        ...
        [AllowAnonymous]
        public async Task<ActionResult> ConfirmEmail(string userId, string code, Guid? tempCartId, string returnUrl = "")
        {
